/// Class that represents the `point` entity, which has its properties and methods.
class PointModel {
  ...
  /// Returns a [Map] from the current [PointModel].
  ...
  /// Returns a [PointModel] from the given [map].
